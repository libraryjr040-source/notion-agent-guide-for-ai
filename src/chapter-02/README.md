...
await connections.notion.updatePage({
  ...
  propertyUpdates: {
    ...
    "Related Tasks": ["example.com", "OPTIONAL_NOTICE"],
  }
})
```
...
await connections.notion.updatePage({
  url: "https://www.notion.so/7fd3f523da6944cd8119bcfeb2d8df72",
  propertyUpdates: {
    "Sub-tasks": ["agent://755c9fa4-4e97-8185-a342-00033edae600/00429878-83b7-4209-8fc4-4f4757072e75", "agent://755c9fa4-4e97-8185-a342-00033edae600/d6640eb9-32d8-4de5-928d-346bbc00b38e", "https://www.notion.so/33ec9fa44e9780138c89f8c2f905d804"]  // 多选
  }
})
```
...
```ts
// 假设 loadDatabase 返回的 data source 中已有模板 https://www.notion.so/766e5b1dbb794308a6133ebc00b307b4
await connections.notion.updateDatabase({
  databaseUrl: "dataSourceUrl",
  edits: [{
    command: "set",
    path: ["dataSources", "okrs", "default_page_template"],
    value: "https://www.notion.so/766e5b1dbb794308a6133ebc00b307b4"
  }]
})
```
...
await connections.notion.deletePages({
  pageUrls: ["https://www.notion.so/766e5b1dbb794308a6133ebc00b307b4"]
})
```
...
```ts
const perms = await connections.notion.loadPermissions({ url: "integration://755c9fa4-4e97-8185-a342-00033edae600/d6640eb9-32d8-4de5-928d-346bbc00b38e/notion/03ea71d9-94ee-4903-9684-b06d4d30d0f3" })
...
```ts
await connections.notion.updatePage({
  url: "integration://755c9fa4-4e97-8185-a342-00033edae600/d6640eb9-32d8-4de5-928d-346bbc00b38e/mcpServer/d1895f66-7416-4c01-8aa3-deed0cab8ad3",
...
await connections.notion.archivePages({
  pageUrls: ["trigger://755c9fa4-4e97-8185-a342-00033edae600/d6640eb9-32d8-4de5-928d-346bbc00b38e/a00de79b-3d9e-44cc-9156-afa4a5ae4581", "user://332d872b-594c-816c-a9a9-000276e2496b", "user://34cc9fa4-4e97-8194-b96b-0027cef5b078"]
})
```
...
await connections.notion.unarchivePages({
  pageUrls: ["trigger://755c9fa4-4e97-8185-a342-00033edae600/d6640eb9-32d8-4de5-928d-346bbc00b38e/a00de79b-3d9e-44cc-9156-afa4a5ae4581", "user://332d872b-594c-816c-a9a9-000276e2496b"]
})
```
...
```ts
await connections.notion.deletePages({
  pageUrls: ["https://www.notion.so/337c9fa44e978052a7fae5508bd47d1c", "https://www.notion.so/33ec9fa44e97803cbc8ee59962af9534"]
})
```
