...
1. **确定 parent**：`{ type: "page", url: "https://www.notion.so/337c9fa44e978052a7fae5508bd47d1c" }` / `{ type: "user", url: "user://332d872b-594c-816c-a9a9-000276e2496b" }` / `{ type: "teamspace", url: "<teamspace-url>" }`
...
| 地理位置 | `place` | map view 的 mapBy 必须引用 place property；值展开为 5 列（address / name / latitude / longitude / google_place_id） |
| 按钮 | `button` | — |
| 验证状态 | `verification` | — |
