...
- **compressed URL**：所有已存在实体的唯一标识，格式如 `"agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40"`（page）、`"dataSourceUrl"`（data source）、`"okrs"`（view）。前缀语义匹配实体类型（`page-`、`data-source-`、`database-`、`view-`、`property-`、`user-`、`agent-`、`teamspace-`、`integration-`、`file-`）。API 调用中引用已有实体必须用 compressed URL，不可用 name。
...
- ⚠️ **参数是 DataSource URL，不是 Database URL**：传 `"agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40"`（data-source 前缀），不是 `"agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40"`（database 前缀）。两者是不同实体。
...
citation 只能引用结果中的 `url` 字段（compressed URL 或 web URL），不能引用搜索工具调用本身的 URL（如 `agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40`）。
...
await connections.notion.createPage({
  parent: { type: "page", url: "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40" },  // wikiPageUrl 的值（page 前缀）
