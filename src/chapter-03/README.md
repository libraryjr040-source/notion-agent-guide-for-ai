...
"CREATE-project": {
  type: "relation",
  name: "Project",
  dataSourceUrl: "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40",  // 目标数据源的 compressed URL
  limit: 1  // 可选，限制只关联一条
}
```
...
"CREATE-task-count": {
  type: "rollup",
  name: "Task Count",
  relationPropertyUrl: "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40",  // 本数据源上的 relation property
  targetPropertyUrl: "dataSourceUrl",    // 目标数据源上要聚合的 property
  aggregation: "count"
}
```
...
await connections.notion.updateDatabase({
  ...
  edits: [
    { command: "set",
      path: ["dataSources", "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40", "schema", "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40", "options"],
      value: [
        { name: "P0", color: "red" },
        { name: "P1", color: "orange" },
        { name: "P2", color: "blue" },
...
- ⚠️ **path 中引用已有实体用 compressed URL**：如 `["dataSources", "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40", "schema", "agent://755c9fa4-4e97-8185-a342-00033edae600/698ee8ff-a788-49fe-b2f4-608ee81dfc40"]`，不要用 display name。
